...
{
    public class DifferentialStrategy : QCAlgorithm
    {
        

        private readonly string _symbol = "AUDUSD";
        private Symbol symbol;
        private const int window_size = 99;

        private Differential _indicator;
        ...
        public override void Initialize()
        {
            ...
            _indicator = DIFF(symbol, window_size, 6, SubscriptionManager, Resolution.Hour);
        ...
        public override void OnData(Slice slice)
        {
            ...
            var signal = _indicator.Current * (-1);
