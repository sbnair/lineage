...
namespace QuantConnect.Tests.Common.Util
{
    ...
    public class ExtensionsTests
    {
        ...
        public void BatchAlphaResultPacket()
        {
            ...
            var orders = new List<Order> { new MarketOrder(btcusd, 1000, DateTime.UtcNow, tag: "ExpensiveOrder") { Id = 1 } };
        ...
        public void BatchAlphaResultPacketDuplicateOrder()
        {
            ...
            {
                new MarketOrder(btcusd, 1000, DateTime.UtcNow, tag: "ExpensiveOrder") { Id = 1 },
                new MarketOrder(btcusd, 100, DateTime.UtcNow, tag: "ExpensiveOrder") { Id = 2 },
                new MarketOrder(btcusd, 2000, DateTime.UtcNow, tag: "ExpensiveOrder") { Id = 1 },
                new MarketOrder(btcusd, 10, DateTime.UtcNow, tag: "ExpensiveOrder") { Id = 3 },
                new MarketOrder(btcusd, 3000, DateTime.UtcNow, tag: "ExpensiveOrder") { Id = 1 }
            };
            var orders2 = new List<Order>
            {
                new MarketOrder(btcusd, 200, DateTime.UtcNow, tag: "ExpensiveOrder") { Id = 2 },
                new MarketOrder(btcusd, 20, DateTime.UtcNow, tag: "ExpensiveOrder") { Id = 3 }
            };
