...
namespace QuantConnect.Tests.Common.Orders
{
    ...
    public class OrderJsonConverterTests
    {
        ...
        {
            var expected = new MarketOrder(Symbols.Lookup(key), 100, new DateTime(2015, 11, 23, 17, 15, 37), tag: "now")
            {
                Id = 12345,
                Price = 209.03m,
                ContingentId = 123456,
        ...
        {
            var expected = new MarketOnOpenOrder(Symbols.Lookup(key), 100, new DateTime(2015, 11, 23, 17, 15, 37), tag:"now")
            {
                Id = 12345,
                Price = 209.03m,
                ContingentId = 123456,
        ...
        {
            var expected = new MarketOnCloseOrder(Symbols.Lookup(key), 100, new DateTime(2015, 11, 23, 17, 15, 37), tag: "now")
            {
                Id = 12345,
                Price = 209.03m,
                ContingentId = 123456,
        ...
        {
            var expected = new LimitOrder(Symbols.Lookup(key), 100, 210.10m, new DateTime(2015, 11, 23, 17, 15, 37), tag: "now")
            {
                Id = 12345,
                Price = 209.03m,
                ContingentId = 123456,
        ...
        {
            var expected = new StopMarketOrder(Symbols.Lookup(key), 100, 210.10m, new DateTime(2015, 11, 23, 17, 15, 37), tag: "now")
            {
                Id = 12345,
                Price = 209.03m,
                ContingentId = 123456,
        ...
        {
            var expected = new StopLimitOrder(Symbols.Lookup(key), 100, 210.10m, 200.23m, new DateTime(2015, 11, 23, 17, 15, 37), tag: "now")
            {
                Id = 12345,
                Price = 209.03m,
                ContingentId = 123456,
...
'AbsoluteQuantity':999}";
        ...
        public void DeserializesOrderGoodTilCanceledTimeInForce()
        {
            ...
            var expected = new MarketOrder(Symbols.BTCUSD, 0.123m, DateTime.Today, tag:"", properties:orderProperties);
            TestOrderType(expected);
        }
        ...
        public void JsonIgnores()
        {
            ...
            json = JsonConvert.SerializeObject(new MarketOrder(Symbols.BTCUSD, 0.123m, DateTime.Today, tag: "This is a Tag"));
