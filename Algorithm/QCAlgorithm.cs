...
namespace QuantConnect.Algorithm
{
    ...
    public partial class QCAlgorithm : MarshalByRefObject, IAlgorithm
    {
        ...
        private ScheduledEventCollection _scheduleEventCollection;
        ...
        public QCAlgorithm()
        {
            ...
            _scheduleEventCollection = new ScheduledEventCollection(this);
        }
        ...
        /// <summary>
        /// Gets ScheduledEventCollection for adding/removing ScheduledEventParams
        /// </summary>
        public ScheduledEventCollection ScheduledEventCollection
        {
            get
            {
                return _scheduleEventCollection;
            }
        }
        ...
        {
            return MarketOrder(symbol, quantity, orderReason: orderReason, tag: tag);
        }
    }
}
