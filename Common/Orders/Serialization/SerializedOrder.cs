...
namespace QuantConnect.Orders.Serialization
{
    ...
    public class SerializedOrder
    {
        ...
        /// </summary>
        [JsonProperty("expiry-date", NullValueHandling = NullValueHandling.Ignore)]
        public double? ExpiryDate { get; set; }

        /// <summary>
        /// Gets the reason for this order, or null if was not specified.
        /// </summary>
        [JsonProperty("reason")]
        ...
        public SerializedOrder(Order order, string algorithmId = "")
        {
            ...
            {
                ExpiryDate = Time.DateTimeToUnixTimeStamp(order.ExpiryDate.Value);
            }
            ...
            Reason = order.Reason == null ? "" : order.Reason.ToString();
        }
    }
}
