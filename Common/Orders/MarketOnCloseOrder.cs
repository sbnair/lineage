...
namespace QuantConnect.Orders
{
    ...
    public class MarketOnCloseOrder : Order
    {
        ...
        public MarketOnCloseOrder(Symbol symbol, decimal quantity, DateTime time, DateTime? expiryDate = null, string tag = "", OrderReason? orderReason = null, IOrderProperties properties = null)
