...
namespace QuantConnect.Orders
{
    ...
    public class SubmitOrderRequest : OrderRequest
    {
        ...
        /// <summary>
        /// Gets the order type of the order
        /// </summary>
        ...
        /// <summary>
        /// Gets the expiry date of the order
        /// </summary>
        ...
        /// <summary>
        /// Gets the reason for this order
        /// </summary>
        [JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
        ...
        /// <param name="expiryDate">The expiry date of the order</param>
        /// <param name="orderReason">The reason for this order</param>
        public SubmitOrderRequest(OrderType orderType, SecurityType securityType, Symbol symbol, decimal quantity, decimal stopPrice, decimal limitPrice, DateTime time, string tag, IOrderProperties properties = null, DateTime? expiryDate = null,
