...
namespace QuantConnect.Orders
{
    ...
    public class StopMarketOrder : Order
    {
        ...
        public StopMarketOrder(Symbol symbol, decimal quantity, decimal stopPrice, DateTime time, DateTime? expiryDate = null, string tag = "", IOrderProperties properties = null)
