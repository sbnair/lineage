...
namespace QuantConnect.Notifications
{
    ...
    public class NotificationTelegram : Notification
    {
        ...
        /// <summary>
        /// Default constructor for sending a telegram notification
        /// </summary>
        
        public NotificationTelegram(string token, string chat_id, string message)
        {
            Token = token;
            Chat_Id = chat_id;
            Message = message;
        ...
        {
            var task = Task.Run(async () => await telegram.SendTextMessageAsync(Chat_Id, Message));
