...
namespace QuantConnect
{
    ...
    public static class Market
    {
        ...
        private static readonly IEnumerable<Tuple<string, int>> HardcodedMarkets = new List<Tuple<string, int>>
        {
            ...
            Tuple.Create(IB, 4),
            Tuple.Create(Dukascopy, 5),
            Tuple.Create(Bitfinex, 6),

            Tuple.Create(Globex, 7),
            Tuple.Create(NYMEX, 8),
            Tuple.Create(CBOT, 9),
            Tuple.Create(ICE, 10),
            Tuple.Create(CBOE, 11),
            Tuple.Create(NSE, 12),

            Tuple.Create(GDAX, 13),
            Tuple.Create(Kraken, 14),
            Tuple.Create(Bittrex, 15),
            Tuple.Create(Bithumb, 16),
            Tuple.Create(Binance, 17),
            Tuple.Create(Poloniex, 18),
            Tuple.Create(Coinone, 19),
            Tuple.Create(HitBTC, 20),
            Tuple.Create(OkCoin, 21),
            Tuple.Create(Bitstamp, 22),
        };
